  ...
  const handleAuthenticate = async () => {
    try {
      ...
      if (!authWindow || authWindow.closed || typeof authWindow.closed === 'undefined') {
        ...
        // Poll for popup close, then auto-refresh auth status
        ...
        {!authStatus?.authenticated && (
          <div className="mb-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              Connect your eBay account to post listings directly from exzellerate.
              ...
              <div className="flex items-start gap-2 text-red-800">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 flex items-center gap-3">
                    <button
                      onClick={() => { setError(null); handleAuthenticate(); }}
                      className="px-3 py-1.5 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-medium transition-colors"
                    >
                      Try Again
                    </button>
                    <a href="/connections" className="text-sm text-gray-600 hover:text-gray-800 underline">
